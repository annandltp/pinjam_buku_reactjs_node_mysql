...
import MahasiswaForm from "pages/Mahasiswa/MahasiswaForm.js";
import MahasiswaEdit from "pages/Mahasiswa/MahasiswaEdit.js";
import Buku from "pages/Buku/Buku.js";
import BukuForm from "pages/Buku/BukuForm.js";
import BukuEdit from "pages/Buku/BukuEdit.js";
import Pinjam from "pages/Pinjam/Pinjam.js";
import PinjamForm from "pages/Pinjam/PinjamForm.js";
import PinjamEdit from "pages/Pinjam/PinjamEdit.js";
                ...
                <Router>
                    <div className="main-container">
                        ...
                        <Switch>
                            ...
                            <Route exact path="/mahasiswa" render={(props) => <Mahasiswa {...props} />} />
                            <Route exact path="/mahasiswa/add" render={(props) => <MahasiswaForm {...props} />} />
                            <Route exact path="/mahasiswa/edit/:set_id" render={(props) => <MahasiswaEdit user={user} {...props} />} />
                            <Route exact path="/buku" render={(props) => <Buku {...props} />} />
                            <Route exact path="/buku/add" render={(props) => <BukuForm {...props} />} />
                            <Route exact path="/buku/edit/:set_id" render={(props) => <BukuEdit user={user} {...props} />} />
                            <Route exact path="/pinjam" render={(props) => <Pinjam {...props} />} />
                            <Route exact path="/pinjam/add" render={(props) => <PinjamForm {...props} />} />
                            <Route exact path="/pinjam/edit/:set_id" render={(props) => <PinjamEdit user={user} {...props} />} />
